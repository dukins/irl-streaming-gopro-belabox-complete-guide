# Guide to stream IRL content with a GoPro (using Belabox)
...
* Usb-C to Usb-C cable (90cm/ 3ft) - for GoPro | Usb-C to Usb-C (20-30cm/1ft) - for Belabox (Jetson Nano) | regular Usb-C to Usb-A cable - for phone | Micro-Usb to Usb-A - for mobile router 
* Waveshare Acrylic Case - for Belabox (Jetson Nano): https://amzn.to/3NEMdOk
